...
<body>
   <header>
    ...
    <div class="sidebar-toggle" onclick="toggleSidebar()">&#9776;</div>
     <ul class="sidebar-menu">
        ...
        <div class="content">
		   ...
		   <label for="nro_cedula">Código Único</label> 
		   <input autofocus type="number" name="nro_cedula" id="nro_cedula" oninput="multiFunction()" required title="Solo se permiten hasta 20 caracteres numéricos"><br><br> 
		   ...
		   <label for="cedula">Expediente</label> 
		   <input type="text" name="cedula" id="cedula" readonly><br><br> 
		   <!-- Campo oculto para búsqueda por año --> 
		   <label for="anio">Año</label> <input type="text" name="anio" id="anio" readonly><br>
		   ...
		   <input type="hidden" name="ipaddress" id="ipaddress" readonly value="<?php echo $ip_address; ?>"><br> 
		   <!-- Sección de Estados en columnas --> 
		   		   <!-- Campo oculto para búsqueda por año --> 
		   <label for="anio">Estado</label><br> 
		   <div class="estado-seccion"> 
			   <div class="estado-columna"> 
					<input type="radio" id="notificado" name="estado" value="Notificado" onclick="mostrarSubtipos()"> 
					<label for="notificado">Notificado (A)</label><br> 
					<div id="subtiposA" class="subtipos"> 
					   <input type="radio" name="subtipoA" value="Entregado con aviso - Bajo Puerta"> Entregado con aviso / Bajo Puerta<br> 
					   <input type="radio" name="subtipoA" value="Con Firma"> Con Firma<br> 
					   <input type="radio" name="subtipoA" value="Con Sello"> Con Sello<br><br> 
					   </div>
					</div> 
			   <div class="estado-columna"> 
			   ...
			   <div class="estado-columna"> 
				<input type="radio" id="oficio" name="estado" value="Otros" onclick="mostrarSubtipos()">
				<label for="oficio">Oficio (C)</label><br> 
			   <div id="subtiposC" class="subtipos">
			   <input type="radio" name="subtipoC" value="Perdida"> Perdida<br>
			   <input type="radio" name="subtipoC" value="Papeleo"> Papeleo<br>
				<br><br> 		   
			   </div> 
			  </div> 
		   </div> 
	...
	<script> function mostrarSubtipos() { 
	const estado = document.querySelector('input[name="estado"]:checked').value; 
	document.getElementById('subtiposA').style.display = (estado === 'Notificado') ? 'block' : 'none'; 
	document.getElementById('subtiposB').style.display = (estado === 'Motivado') ? 'block' : 'none'; 
	document.getElementById('subtiposC').style.display = (estado === 'Otros') ? 'block' : 'none'; 
	} 
	</script>
